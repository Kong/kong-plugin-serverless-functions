...
describe("post-function schema", function()
  ...
  describe("errors", function()
    it("with an invalid function", function()
      ...
      assert.falsy(ok)
      assert.equals("Error parsing post-function: [string \"print(\"]:1: unexpected symbol near '<eof>'", err.config.functions[1])
    end)
    ...
    it("with a valid and invalid function", function()
      ...
      assert.falsy(ok)
      assert.equals("Error parsing post-function: [string \"print(\"]:1: unexpected symbol near '<eof>'", err.config.functions[2])
    end)
  end)
end)
